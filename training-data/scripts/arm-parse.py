...
# --- Configuration ---
MAX_FILE_SIZE_KB = 100  # Skip very large Bicep files
...
def process_bicep_file(bicep_file_path):
    ...
    try:
        ...
        # 3. Create a single data pair with an empty prompt placeholder.
        # This placeholder is where the VS Code Copilot Agent will add the prompts.
        training_pair = {
            "prompt": "",
...
def main():
    ...
    root_dir = '.' # Assumes script is in the root of the repo
    ...
    with open(output_filename, 'w', encoding='utf-8') as f_out:
        with ProcessPoolExecutor() as executor:
            # The map function applies 'process_bicep_file' to each path.
            # It runs them concurrently and returns an iterator of the results.
